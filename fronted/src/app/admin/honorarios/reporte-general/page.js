// app/admin/honorarios/reporte-general/page.js - VERSIÓN COMPLETA
'use client';
...
// Componente de impresión separado
const PrintReporte = ({ reporteData, onClose }) => {
    useEffect(() => {
...
export default function ReporteGeneralPage() {
    ...
    useEffect(() => {
        const data = localStorage.getItem('reporteGeneralData');
        if (data) {
            const parsedData = JSON.parse(data);
            console.log('📊 Datos del reporte general:', parsedData);
            setReporteData(parsedData);
        } else {
            console.log('❌ No hay datos de reporte general en localStorage');
        ...
        return (
            <div className={styles.pageContainer}>
                ...
                <div className={styles.errorContainer}>
                    ...
                    <p>No se encontraron datos para generar el reporte general.</p>
        ...
        <div className={styles.pageContainer}>
            ...
            <header className={styles.header}>
                <div className={styles.titleSection}>
                    <h1>Reporte General de Honorarios</h1>
                    <p>Resumen consolidado de todos los instructores</p>
                </div>
            ...
            <main className={styles.mainContent}>
                ...
                <div className={styles.controls}>
                    ...
                    <div className={styles.controlsRight}>
                        <button onClick={imprimirReporte} className={styles.btnImprimir}>
                            🖨️ Imprimir Reporte
                        </button>
                    </div>
                </div>
                ...
                <div className={styles.reporteContainer}>
                    <div className={styles.reporte}>
                        ...
                        <div className={styles.reporteHeader}>
                            <div className={styles.companyInfo}>
                                <div className={styles.companyLogo}>
                                    <img src="/logo.jpg" alt="BEYCO Logo" className={styles.reporteLogo} />
                            ...
                            <div className={styles.reporteInfo}>
                                <div className={styles.folio}>
                                    ...
                                    <span className={styles.folioValue}>REP-{new Date().getFullYear()}{(new Date().getMonth() + 1).toString().padStart(2, '0')}-{new Date().getTime().toString().slice(-6)}</span>
                                </div>
                        ...
                        {/* Título principal */}
                        <div className={styles.reporteTitle}>
                            <h2>REPORTE GENERAL DE HONORARIOS</h2>
                            <p>Resumen consolidado del período</p>
                        </div>

                        {/* Información del Período */}
                        <div className={styles.periodoSection}>
                            ...
                            <div className={styles.resumenGrid}>
                                <div className={styles.resumenCard}>
                                    ...
                                    <div className={styles.resumenContent}>
                                        <span className={styles.resumenNumber}>{reporteData.instructores.length}</span>
                                        <span className={styles.resumenLabel}>Instructores</span>
                                    </div>
                                </div>
                                <div className={styles.resumenCard}>
                                    <div className={styles.resumenIcon}>📚</div>
                                    <div className={styles.resumenContent}>
                                        <span className={styles.resumenNumber}>{reporteData.totalCursosGeneral}</span>
                                        <span className={styles.resumenLabel}>Total Cursos</span>
                                    </div>
                                </div>
                                <div className={styles.resumenCard}>
                                    <div className={styles.resumenIcon}>⏱️</div>
                                    <div className={styles.resumenContent}>
                                        <span className={styles.resumenNumber}>{reporteData.totalHorasGeneral}</span>
                                        <span className={styles.resumenLabel}>Horas Totales</span>
                                    </div>
                                </div>
                                <div className={`${styles.resumenCard} ${styles.resumenTotal}`}>
                                    <div className={styles.resumenIcon}>💰</div>
                                    <div className={styles.resumenContent}>
                                        <span className={styles.resumenNumber}>
                                            {formatCurrency(reporteData.totalGeneral)}
                                        </span>
                        ...
                        <div style={{ textAlign: 'center', padding: '20px', background: '#f8f9fa', borderRadius: '8px', marginBottom: '20px' }}>
                            <p style={{ margin: 0, color: '#666' }}>
                                Este es una vista previa del reporte. Haz clic en "Imprimir Reporte" para generar la versión imprimible.
                            </p>
                        </div>
                    </div>
                </div>
