// app/secretaria/recibos/page.js
'use client';
...
export default function Recibos() {
    ...
    const generarRecibo = () => {
        ...
        console.log('💾 Preparando datos del recibo:', reciboData);
        console.log('📊 Instructor:', reciboData.instructor);
        console.log('📚 Cursos:', reciboData.cursos.length);
        
        // Guardar en localStorage para usar en la página de recibo
        try {
            // Limpiar primero cualquier dato anterior
            localStorage.removeItem('reciboHonorariosData');
            
            // Guardar los nuevos datos
            localStorage.setItem('reciboHonorariosData', JSON.stringify(reciboData));
            
            // Verificar que se guardó correctamente
            const datosGuardados = localStorage.getItem('reciboHonorariosData');
            if (datosGuardados) {
                console.log('✅ Datos guardados correctamente en localStorage');
                console.log('🔍 Verificación:', JSON.parse(datosGuardados).instructor?.instructorNombre);
                
                // Redirigir a la página de recibo
                setTimeout(() => {
                    window.location.href = '/secretaria/recibos/recibo';
                }, 100);
            } else {
            ...
            setError('Error al preparar el recibo: ' + error.message);
        }
    };
        ...
        <div className={styles.pageContainer}>
            ...
            <header className={styles.header}>
                <div className={styles.titleSection}>
                    ...
                    <p>Sistema de gestión de pagos a instructores - Secretaría</p>
                </div>
                            ...
                            <div className={styles.instructorCard}>
                                ...
                                <div className={styles.instructorInfo}>
                                    ...
                                    <div className={styles.infoRow}>
                                        ...
                                        <span className={styles.infoValue}>
                                            {instructorSeleccionado.instructorEspecialidad}
                                        </span>
                                    </div>
                                    <div className={styles.infoRow}>
                    ...
                    <div className={styles.detailsPanel}>
                        {instructorSeleccionado ? (
                            <>
                                ...
                                <div className={styles.instructorHeader}>
                                    <div className={styles.instructorTitle}>
                                        ...
                                        <p>{instructorSeleccionado.instructorEmail} • {instructorSeleccionado.instructorEspecialidad}</p>
                            ...
                            <div className={styles.placeholder}>
                                ...
                                <p>Elige un instructor de la lista para ver sus cursos y generar recibos de honorarios</p>
